package com.example.todonotesapp.blog.adapter
...
import com.example.todonotesapp.blog.adapter.BlogsAdapter.ViewHolder
import com.example.todonotesapp.data.remote.model.Data

class BlogsAdapter(val list: List<Data>):RecyclerView.Adapter<ViewHolder>(){
