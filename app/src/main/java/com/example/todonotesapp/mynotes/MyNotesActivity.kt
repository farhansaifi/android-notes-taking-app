package com.example.todonotesapp.mynotes
...
import com.example.todonotesapp.addnotes.AddNotesActivity
import com.example.todonotesapp.blog.BlogActivity
import com.example.todonotesapp.detail.DetailActivity
import com.example.todonotesapp.mynotes.adapter.NotesAdapter
...
import com.example.todonotesapp.utils.workmanager.MyWorker
...
class MyNotesActivity :AppCompatActivity() {
    ...
    private fun getIntentData() {
        ...
        // Get full_name from shared_Preference and set on tool bar
        /*fullName = sharedPreferences.getString(PrefConstant.FULL_NAME, "")!!*/
        fullName = StoreSession.read(PrefConstant.FULL_NAME,"")
    }
